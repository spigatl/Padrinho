...
if (isset($_POST['cadastrar'])) {
    ...
    if ($fr_img == '') {
        $db->query("UPDATE EMPRESA SET E_EMPRESA = '$fr_nome', E_COMENTARIO = '$fr_coment', E_RUA = '$fr_end', E_NUMERO = '$fr_num', E_UF = '$fr_uf', E_TEL = '$fr_tel', E_MAIL = '$fr_mail', E_SITE = '$fr_site', E_CIDADE = '$fr_cidade', E_CATEGORIA = '$fr_ctg', E_ID = '$fr_id', E_CNPJ = '$fr_cpf', E_CEP = '$fr_cep', E_BAIRRO = '$fr_bairro'") or die($db->error);
    } else {
        $db->query("UPDATE EMPRESA SET E_EMPRESA = '$fr_nome', E_COMENTARIO = '$fr_coment', E_RUA = '$fr_end', E_NUMERO = '$fr_num', E_UF = '$fr_uf', E_TEL = '$fr_tel', E_MAIL = '$fr_mail', E_SITE = '$fr_site', E_CIDADE = '$fr_cidade', E_CATEGORIA = '$fr_ctg', E_ID = '$fr_id', E_CNPJ = '$fr_cpf', E_CEP = '$fr_cep', E_BAIRRO = '$fr_bairro', E_IMG = '$fr_img'") or die($db->error);   
    }
                     ...
                     <fieldset class="step">
                        <legend>1. Logo</legend>
                            ...
                            <div style="width: 20%; float: left; border-right: 1px solid #d6d6d6;">
                                ...
                                <img id="photo" src="<? echo "fotos_empresa/". $row['E_IMG']; ?>" style="width: 98px;">
                                <div id="file1c">
