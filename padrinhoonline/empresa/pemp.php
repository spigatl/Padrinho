...
<link rel="stylesheet" href="<?php echo $end; ?>css/pempresa.css" />
...
if (!empty($page)) {
	...
	echo "<script src=". $end ."js/confere4.js type=text/javascript></script>
	<script src=". $end ."js/jquery.easing.1.3.js type=text/javascript></script>
	<script src=". $end ."js/jquery.ibutton.js type=text/javascript></script>
	<script src=". $end ."js/jquery.metadata.js type=text/javascript></script>";
	}
}
?>
...
<script type="text/javascript">
	...
	function deletar(valor) {
		window.location =  "pemp.php?p=pempdelete&code=" + valor;
	}
	function cadastro() {
                    ...
                    <fieldset class="step">
                        <legend>Empresa</legend>
                        	<div id="photodiv" style="width: 200px; float: left">
                       		...
                       		<div id="photodiv" style="width: 520px; float: left">
                       			<?php
                       			$page = $_GET['p'];
								$pages = array('pempmail', 'pempsenha', 'pemplista', 'pempcadastro', 'concluido', 'eeditar', 'pempdelete');
								if (!empty($page)) {
									if(in_array($page,$pages)) {
										$page .= '.php';
										include($page);
