...
<link rel="stylesheet" href="css/loclista.css" />
            ...
            <div id="wrapper">
               <div id="steps">
                 <form id="formElem" name="formElem" action="" method="post">
                    <fieldset class="step">
                            <legend>Localizar</legend>
                        	 <p class="p2">
                                <label for="numero">Codigo:</label>
                                <input id="numero" name="numero" type="text" maxlength="7" AUTOCOMPLETE=OFF />
                            </p>
                        	<button id="registerButton" type="submit">Localizar</button>
                        </fieldset>
                 </form>   
                </div>
            </div>
