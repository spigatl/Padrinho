...
<link rel="stylesheet" href="<?php echo $end; ?>css/perfil.css" />
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>.: Padrinho Online :. Melhor Sites de Lista de Casamento.</title>
<script src="<?php echo $end; ?>js/jquery-1.7.2.min.js" type="text/javascript"></script>
<script src="<?php echo $end; ?>js/idlocal.js" type="text/javascript"></script>
<script src="<?php echo $end; ?>js/jquery.maskedinput-1.3.min.js" type="text/javascript"></script>
<script src="<?php echo $end; ?>js/confere2.js" type="text/javascript"></script>
...
<script type="text/javascript">
	...
	function red($valor) {
           echo "<script type=\"text/javascript\">
            		$(function() {
            			$('#$valor').css('background-color', '#FFEDEF');
        			});
				</script>";    
            } 
	?>		
...
<body>
<img class="extradiv" src="<?php echo $end; ?>imagens/radial.png" alt="" />
<div id="corpo">
<h1 id="logo1"></h1>
<h2 id="logo2"></h2>
...
<div id="boxes">
  <div id="content">
            <div id="wrapper">
                <div id="steps">
                    <fieldset class="step">
                        <legend><?php if(isset($noivo['0'])) { echo "$noivo[0]&nbsp;"; }
                        			  if(isset($noivo['1'])) { echo "$noivo[1]&nbsp;"; } 
                        			  echo "&amp;&nbsp;"; 
                        			  if(isset($noiva['0'])) { echo "$noiva[0]&nbsp;"; }
                        			  if(isset($noiva['1'])) { echo "$noiva[1]"; }
                        			  ?>
                        </legend>
                        	<div id="photodiv" style="width: 230px; float: left">
                        		<p>
                        			<div id="estado">
                        				<div>
                        					<div style="position: relative" class="com-sombra">
	                        					...
	                        					<div class="sombra" style="position: absolute; bottom: 0; left: 0; right: 0;">
		                        							...
		                        							<li><a id="alterar" href="perfil.php?p=editar">Alterar Foto do Perfil</a></li>
		                        						</p>
	                        					</div>
	                        				</div>
	                        			</div>
	                        			<ul>
		                        			...
		                        			<li>
		                        				<a href="?p=dados">Alterar Dados Pessoais</a>
		                        			</li>
		                        			<li>
		                        				<a href="?p=senha">Alterar Senha</a>
		                        			</li>
		                        			<li>
		                        				<a href="?p=email">Alterar E-mail</a>
		                        			</li>
                       		...
                       		<div id="photodiv" style="width: 480px; float: left">
                       			<?php
                       			$page = $_GET['p'];
								$pages = array('inicio', 'dados', 'senha', 'result', 'editar', 'email');
								if (!empty($page)) {
